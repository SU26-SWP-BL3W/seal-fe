...
import { useCoordinatorAssignTemplateViewModel } from "@/viewModels/coordinator/useCoordinatorAssignTemplateViewModel";

export const CoordinatorAssignTemplateView: React.FC = () => {
  const { state, actions } = useCoordinatorAssignTemplateViewModel();
  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen bg-[#0e1417] text-[#dde4e6] font-sans">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 font-mono text-xs">
                ...
                <select
                  ...
                  onChange={(e) => {
                    actions.setSelectedTemplateId(e.target.value);
        ...
        <div className="bg-[#161d1f] border border-[#3c494d] p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 justify-end">
            ...
            <button
              ...
              onClick={actions.handleAssignTemplate}
      ...
      <UnsavedChangesModal
        isOpen={showModal}
        onConfirmLeave={actions.confirmLeave}
        onCancelStay={actions.cancelStay}
      />
    </div>
  );
};
