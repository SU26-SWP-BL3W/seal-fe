            ...
            <div className="w-full overflow-x-auto border border-[var(--border-muted)] bg-[var(--bg-panel)] hud-clipped">
              <table className="w-full text-left border-collapse font-sans">
                <thead className="bg-[var(--bg-base)] border-b border-[var(--border-muted)]">
                  <tr>
                    <th className="w-[26%] px-3.5 py-3.5 text-left font-mono text-xs text-[var(--text-muted)] uppercase tracking-wider">
                      TÊN SỰ KIỆN & MÃ ID
                    </th>
                    <th className="w-[14%] px-3 py-3.5 text-left font-mono text-xs text-[var(--text-muted)] uppercase tracking-wider">
                      MÙA GIẢI
                    </th>
                    <th className="w-[11%] px-3 py-3.5 text-left font-mono text-xs text-[var(--text-muted)] uppercase tracking-wider">
                      VÒNG THI
                    </th>
                    <th className="w-[18%] px-3 py-3.5 text-left font-mono text-xs text-[var(--text-muted)] uppercase tracking-wider">
                      EVENT COORDINATOR (EC)
                    </th>
                    <th className="w-[11%] px-2.5 py-3.5 text-center font-mono text-xs text-[var(--text-muted)] uppercase tracking-wider">
                      TRẠNG THÁI
                    </th>
                    <th className="w-[20%] px-3.5 py-3.5 text-right font-mono text-xs text-[var(--text-muted)] uppercase tracking-wider">
                      THAO TÁC
                    </th>
                  </tr>
                </thead>
                    ...
                    return (
                      <tr key={id} className="hover:bg-[var(--color-danger)]/5 transition-colors group">
                        ...
                        <td className="px-3 py-3.5 align-middle text-center">
                          <span className="inline-flex items-center justify-center gap-1.5 px-2.5 py-1 text-[10px] font-mono font-bold bg-[rgba(16,185,129,0.12)] text-[var(--color-success)] border border-[var(--color-success)]/30 uppercase rounded whitespace-nowrap">
