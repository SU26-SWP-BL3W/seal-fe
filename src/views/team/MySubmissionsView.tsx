...
export function MySubmissionsView() {
  const { user } = useAuth();
  const { state, data, pagination, actions } = useMySubmissionsViewModel();
                        ...
                        <td className="py-4 px-4 text-right whitespace-nowrap">
                          <div className="flex items-center justify-end gap-2">
                            {isActive && !isEliminated && (
                              <button
                                onClick={() => actions.handleOpenEdit(sub)}
                            ...
                            {isLeader && (
                              <button
                                onClick={() => actions.handleDelete(sub)}
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#080f11] border border-[#00d9ff] p-6 max-w-xl w-full glow-box relative space-y-4">
            ...
            <div className="flex items-center justify-between border-b border-white/10 pb-3">
              ...
              <button onClick={() => actions.setEditingSub(null)} className="text-[#859398] hover:text-white font-mono cursor-pointer">
                <X className="w-4 h-4" />
              </button>
            </div>

            <form onSubmit={actions.handleSaveEdit} className="space-y-4 font-mono text-xs">
              <div>
                ...
                <input
                  ...
                  required
                  value={editRepo}
                  onChange={(e) => actions.setEditRepo(e.target.value)}
              ...
              <div>
                ...
                <input
                  ...
                  required
                  value={editDemo}
                  onChange={(e) => actions.setEditDemo(e.target.value)}
                  className="w-full input-cyber p-2.5 bg-[#152238] text-white border-b border-[#3c494d] focus:border-[#00d9ff]"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  required
                  value={editSlide}
                  onChange={(e) => actions.setEditSlide(e.target.value)}
                  className="w-full input-cyber p-2.5 bg-[#152238] text-white border-b border-[#3c494d] focus:border-[#00d9ff]"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  rows={2}
                  value={editDesc}
                  onChange={(e) => actions.setEditDesc(e.target.value)}
                  className="w-full input-cyber p-2.5 bg-[#152238] text-white border-b border-[#3c494d] focus:border-[#00d9ff]"
                />
              </div>
              ...
              <div className="flex justify-end gap-3 pt-3 border-t border-white/10">
                <button
                  type="button"
                  onClick={() => actions.setEditingSub(null)}
